...
Original file is located at
    https://colab.research.google.com/drive/1gfOSUKTDB4e49oikYYiCd94OZyt-21Sv
"""
...
labelled_dataset = pd.read_csv('/content/drive/MyDrive/database_with_activities.csv')

# Définir la classe du dataset personnalisé
# Définir la classe du dataset personnalisé
class CustomDataset(Dataset):
    def __init__(self, csv_file):
        self.data = pd.read_csv(csv_file)  # Lire le fichier CSV dans un DataFrame
...
dataset = CustomDataset('/content/drive/MyDrive/labelled_dataset.csv')
